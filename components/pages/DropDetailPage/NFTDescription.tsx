            ...
            <div className="collapse collapse-arrow join-item border border-base-300">
                ...
                <div className="collapse-content">
                    <div className='flex items-center justify-between gap-2'>
                        ...
                        <Link href={`${NetworkList.find(item => item.id === collection.network)?.explorer}${nftData.contractAddress}`} target='_block'>
                    ...
                    <div className='flex items-center justify-between gap-2'>
                        ...
                        <div>{NetworkList.find(item => item.id === collection.network)?.network}</div>
                    </div>
                    <div className='flex items-center justify-between gap-2'>
                        <div className='badge badge-sm'>Creator Earnings</div>
                        <div>{nftData.royalFee}%</div>
                    </div>
                </div>
            </div>
        </div>
